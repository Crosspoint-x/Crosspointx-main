  ...
  return (
    <>
      <div className="LoginContainer">
        ...
        <form onSubmit={handleLogin}> {/* Add the form element */}
          <input
          ...
          <button type="submit" className="button"> {/* Button is now part of the form */}
      ...
      <div className="socials">
        <a href="https://discord.gg/qxg5pMna" target="_blank" rel="noopener noreferrer" className="social-icon">
        <span>Discord</span><FaDiscord /> 
        </a>
        <a href="https://www.instagram.com/cpx_technologies/" target="_blank" rel="noopener noreferrer" className="social-icon">
        <span>Instagram</span><FaInstagram /> 
        </a>
        <a href="https://www.tiktok.com/@cross.pointx?_t=8qHNa5dPqJi&_r=1" target="_blank" rel="noopener noreferrer" className="social-icon">
        <span>Tiktok</span><FaTiktok /> 
        </a>
